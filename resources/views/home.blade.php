...
<body class="bg-gray-100">
    <div class="bg-white rounded-lg shadow-lg flex w-full min-h-screen">
        <div
            class="bg-gradient-to-b from-blue-400 via-blue-500 to-blue-600 text-white p-8 rounded-l-lg flex flex-col justify-center items-center w-1/3">
            ...
            <p class="text-center">Penyimpanan berbagai dokumentasi sistem yang berkaitan dengan sistem yang ada di
                lingkungan LLDIKTI V </p>
            <img alt="Illustration of login process" class="mt-24" height="200"
        ...
        <div class="p-16 w-2/3 flex flex-col justify-center relative">
            ...
            <div class="bg-gradient-to-r from-blue-400 to-blue-600 p-8 rounded-lg shadow-gradient relative z-10">
                ...
                <form action="/admin/dashboardadmin" method="get">
                    <div class="mb-4">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-400 text-white p-3 rounded-lg font-semibold hover:bg-blue-500 transition duration-300 shadow-md">Login</button>
                </form>
